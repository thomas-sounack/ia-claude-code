...
Write-Host ''
Write-Host '============================================'
Write-Host ' Step 7/9: Writing Claude Code configuration'
Write-Host '============================================'
...
'@
[System.IO.File]::WriteAllText((Join-Path $env:USERPROFILE '.mcp.json'), $McpJson)
...
Write-Host 'Claude Code configuration written.'
