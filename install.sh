...
REPO_URL="https://github.com/thomas-sounack/ia-claude-code.git"
REPO_DIR="$HOME/ia-claude-code"
...
echo ''
echo '============================================'
echo ' Step 2/8: Installing Databricks CLI'
echo '============================================'
...
echo ''
echo '============================================'
echo ' Step 3/8: Authenticating with Databricks'
echo '============================================'
...
# Patch the apiKeyHelper path in the cloned settings.json to use the real home dir
...
data["apiKeyHelper"] = helper.replace("~", home)
